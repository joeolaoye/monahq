      ...
      <div className="container mx-auto px-4 py-12 md:py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12 md:mb-16">
            ...
            <div className="bg-card/10 backdrop-blur-sm rounded-xl p-6 border border-primary-foreground/10 animate-slide-up" style={{ animationDelay: "0.1s" }}>
              <div className="w-12 h-12 bg-accent rounded-lg flex items-center justify-center mb-4">
                <svg className="w-6 h-6 text-accent-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-card/10 backdrop-blur-sm rounded-xl p-6 border border-primary-foreground/10 animate-slide-up" style={{ animationDelay: "0.2s" }}>
              <div className="w-12 h-12 bg-accent rounded-lg flex items-center justify-center mb-4">
                <svg className="w-6 h-6 text-accent-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24">
